...
- **Bamse** : implémente à partir de `plan.txt`, vérifie, écrit `.opencode/resume/build.txt`. Seul à modifier le code.
...
- Dernier état dans `.opencode/resume/` : `plan.txt`, `build.txt`, `review.txt`, `security.txt`, `qa.txt`.
- Avant remplacement, archiver l'ancien contenu dans `.opencode/history/` (`build-log.md`, `review-log.md`, `security-log.md`, `qa-log.md`).
